    ...
    def show_entry(self, text_surf, amount, top, selected):
        ...
        if selected:
            ...
            if self.index <= self.sell_border: #sell
                sell_rect = self.sell_text.get_rect(midleft = (self.main_rect.left + 150, bg_rect.centery))
                self.display_surface.blit(self.sell_text, sell_rect)
            else: #buy
                buy_rect = self.sell_text.get_rect(midleft = (self.main_rect.left + 150, bg_rect.centery))
